...
namespace ImGui
{
    ...
    IMGUI_API bool          LightButtonEx(const char* label, const char* icos, bool selected, ImGuiButtonFlags flags);
    IMGUI_API bool          LightButtonEx1(const char* label, const char* icos, bool selected, ImGuiButtonFlags flags);
    ...
    IMGUI_API void          BinderBox(const char* label, const char* label_v, bool* v, int* vs);
    IMGUI_API void          ButtonBox(const char* label, const char* label_v, int* vs);
    IMGUI_API void          CollorBox(const char* label, const char* label_v, bool* v, float* col, ImGuiColorEditFlags flags);
